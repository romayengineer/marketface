...
class TestRateLimiter(unittest.TestCase):
    ...
    def test_token_bucket_1(self):
        ...
        requests_count = 5
        time_should_take = requests_count * tokens_per_request * (1 / requests_per_second)
        ...
        # assert the time it took to run is not higher than time expected + 0.5%
        self.assertLessEqual(time_elapsed, time_should_take * 1.005)
